...
private:
  ...
  int loadBgTextEngine(vu16 *bg3Reg, u16 *paletteRam, u16 *tileRam,
                       u16 *mapRam);
  int loadBgExtendedEngine(vu16 *bg3Reg, u16 *paletteRam, u16 *tileRam,
                           u16 *mapRam, vs16 *reg3A, vs16 *reg3B, vs16 *reg3C,
                           vs16 *reg3D, int forceSize);
  int loadBgRectEngine(const vu16 *bg3Reg, u16 *tileRam, u16 *mapRam, int x,
                       int y, int w, int h);
