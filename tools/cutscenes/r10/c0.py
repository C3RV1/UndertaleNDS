...
def cutscene(c: Cutscene):
    ...
    c.load_sprite_relative(
        0, 0, 29 - (10 // 2), "room_sprites/hole", Target(TargetType.PLAYER)
    )
    ...
    frames = frames_from_dst(220, 150)
    c.move_in_frames(Target(TargetType.PLAYER), 0, 220, frames)
    c.play_sfx("snd_fall2.wav")
    c.wait(WaitTypes.FRAMES, frames)
